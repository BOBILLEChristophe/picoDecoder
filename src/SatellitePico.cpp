 ...
 */
 ...
 static const uint32_t kClockPin2515 = 26;
 
 /*------------------------------------------------------------------------------
  * begin has to be called to start the CAN.
  * begin does the following:
  * - program GPIO 26 to output a 16MHz clock using a PWM. GPIO 26 is
 ...
 void SatellitePico::selfTest() {
   ...
   /* begin the CAN */
   ACAN2515Settings settings(k2515ClockFrequency, 1000UL * 1000UL);
